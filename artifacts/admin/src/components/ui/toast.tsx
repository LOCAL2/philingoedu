...
// ── ToastContainer — renders active toasts from global useToastState ──────────
    ...
    <div className="fixed bottom-4 right-4 z-[200] flex flex-col gap-2 max-w-sm w-full">
      {toasts.map((t) => (
        <div
          key={t.id}
          className={cn(
            'flex items-center justify-between rounded-lg border px-4 py-3 shadow-lg text-sm font-medium',
